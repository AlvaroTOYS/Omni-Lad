function onCreate()
	-- background shit
	makeLuaSprite('stageOmni', 'stageOmni', -600, -300);
	setLuaSpriteScrollFactor('stageback', 0.9, 0.9);
	
	makeLuaSprite('no', 'no', -650, 600);
	setLuaSpriteScrollFactor('stageOmnif', 0.9, 0.9);
	scaleObject('stageOmnif', 1.1, 1.1);
	...
	addLuaSprite('stageOmni', false);
	addLuaSprite('stageOmnif', false);
